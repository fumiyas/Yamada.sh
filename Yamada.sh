#!/bin/sh
##
## Yamada.sh -  Dancing Yamada
## Copyright (c) 2014 SATOH Fumiyasu @ OSS Technology Corp., Japan
##
## License: GNU General Public License version 3
##
## See https://github.com/supermomonga/awesome-yamada
##
...
Yamada() {
  trap 'tput cnorm; Yamada=end' HUP INT TERM
  tput civis

  Yamada=
  while [ -z "$Yamada" ]; do
    for Yamada_n in 1 2 3 4 5 6 7; do
      clear
      eval "echo \"\$Yamada_$Yamada_n\""
      sleep "$Yamada_interval"
    done
  done
}

return 2>/dev/null || Yamada
